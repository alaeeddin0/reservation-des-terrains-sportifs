...
<body>
                                                    ...
                                                    <tr class="client-row">
                                                        ...
                                                        <td>
                                                            ...
                                                            <button type="button" class="btn btn-danger btn-sm"
                                                                ...
                                                                onclick="editUser(<?= $user['id']; ?>, '<?= esc($user['nom']); ?>', '<?= esc($user['email']); ?>')">
                                                            ...
                                                            <form action="/Utilisateurs_liste/delete/<?= $user['id']; ?>"
                                                        ...
                                                        <div class="modal-dialog" role="document">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                                    <h5 class="modal-title" id="editModalLabel">Modifier les
                                                                        informations</h5>
                                                                ...
                                                                <div class="modal-body">
                                                                    <form
                                                                        action="/Utilisateurs_liste/update/<?= $user['id']; ?>"
                                                                        method="post">
                                                                        <?= csrf_field(); ?>
    ...
    <script>function editUser(userId, userName, userEmail) {
            document.getElementById('nom').value = userName;
            document.getElementById('email').value = userEmail;

            let formAction = '/Utilisateurs_liste/update/' + userId;
            document.querySelector('#editModal' + userId + ' form').action = formAction;
        }
    </script>
